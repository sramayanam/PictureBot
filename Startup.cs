    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<BasicBotAccessors>(sp =>
            {
                ...
                var accessors = new BasicBotAccessors(conversationState)
                {
                    PictureState = conversationState.CreateProperty<PictureState>(BasicBotAccessors.PictureStateName),
            ...
            services.AddSingleton(sp =>
            {
                ...
                var luisApp = new LuisApplication("0e5b062d-9f97-45f7-a272-d2dd8b935ed3",
                    "ce6ada59f1ac45a7bcc52ce955fe2db2",
